...
export default function ProcessPage() {
  ...
  const importData = (data: any) => {
    ...
    if (data.mlfqQueues) setMlfqQueues(data.mlfqQueues)
    if (data.mlfqQuantums) setMlfqQuantums(data.mlfqQuantums)
    if (data.mlfqAllotment) setMlfqAllotment(data.mlfqAllotment)
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <ActionModal
                ...
                filename="cpu-scheduling-simulation.json"
                buttonText="Actions"
                modalTitle="CPU Scheduling Actions"
